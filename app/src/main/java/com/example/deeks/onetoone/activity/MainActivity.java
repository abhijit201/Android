...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Home) {
           startActivity(new Intent(this,MainActivity.class));
            ...
            startActivity(new Intent(this,Add_Your_Bussiness_Activity.class));
            ...
            Toast.makeText(this, "Complaint this App", Toast.LENGTH_SHORT).show();


        }else if (id == R.id.nav_Feedback) {

            Toast.makeText(this, "FeedBack this App", Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        homeFragment listofServices = new homeFragment();
